    ...
    const dummyTestimonialData = [
        {
            image: "",
            name: 'Jose Bento',
            title: 'Director, Giovanni Monti Ltd',
        ...
        },
        {
            image: "",
            name: 'Mark Johnson',
            title: 'Content Creator, MiniMouse',
        ...
        },
        {
            image: "",
            name: 'David Lee',
            title: 'Human Resource, Jakeson Inc',
    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 py-24'>
            <div className='text-center'>
                <h2 className='text-black-700 text-[42px] font-semibold'>Loved by Creators</h2>
                <p className='text-black-500 max-w-lg mx-auto'>Don't just take our word for it. Here's what our users are saying.</p>
            </div>
